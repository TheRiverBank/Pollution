...
```{r}
ocean <- c("ocean1,", "ocean2")
longditude <- c(-20, -39)
latitude <- c(33, 35)
value <- c(5, 10)

testdata <- data.frame(ocean, longditude, latitude, value)
...
base_world <- base_world_messy + geom_point(data=testdata, aes(x=longditude, y=latitude, size=value),
                                            colour="blue", fill="blue", pch=21, alpha=I(0.3))
